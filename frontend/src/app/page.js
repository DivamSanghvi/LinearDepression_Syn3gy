...
import { 
  BookOpen, Search, MessageCircleQuestion, NotebookPen, Link2, 
  BrainCircuit, Rocket, Video, Zap, Timer, LayoutTemplate,
  GraduationCap, Database, TestTube2, Globe, Users, ChevronRight
} from "lucide-react"
      ...
      <nav className="fixed w-full z-50 bg-black/80 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white">VidLearn AI</span>
          </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-36 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-sm text-white/60">AI-Powered Learning Platform</span>
            </motion.div>
            ...
            <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
              <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 tracking-tight">
                ...
                <br />
                <span className={cn("bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white/90 to-purple-300", pacifico.className)}>
            ...
            <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
              <p className="text-lg text-white/50 mb-12 max-w-2xl mx-auto leading-relaxed">
                Revolutionize educational video consumption through AI-powered interactivity, 
                intelligent navigation, and contextual knowledge integration.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/60 mb-8">
              Join educators and students worldwide transforming their video learning experience
            </p>
            <motion.div
      ...
      <footer className="py-20 border-t border-white/10">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-white/60">
            <div>
              <h4 className="text-white font-semibold mb-4">VidLearn AI</h4>
          ...
          <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm text-white/50">
            © 2024 VidLearn AI. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
